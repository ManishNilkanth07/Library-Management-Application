...
<%
    if (request.getAttribute("bookList") == null) {
        response.sendRedirect("GetAllBooksServlet?page=view");
        return;
    }
%>
<!DOCTYPE html>
                            ...
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <!-- Edit Button: Links to edit page with bookId -->
                                        <a href="editBook.jsp?book_id=${book.bookId}" class="btn btn-warning btn-sm">
